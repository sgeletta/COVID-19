Data work.TSTEDPSUMOUT(drop=datel);
retain dates;
set work.tecondepsum;
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
PROC SORT
	DATA=WORK.TSTEDPSUMOUT(KEEP=dates Cases1 EconDepTypoCode2015)
	OUT=WORK.SORTEcondepSorted
	;
	BY  dates;
RUN;
...
FOOTNOTE;
PROC GPLOT DATA = WORK.SORTEcondepSorted
 NOCACHE ;
